...
export default function TestStPeteSharpPage() {
  ...
  const designOptions = [
    {
      id: 1,
      name: "Warm + Sharp B&W",
      description: "Warm neutrals with sharp black and white accents",
    ...
    },
    {
      ...
      description: "Warm base with sophisticated typography hierarchy",
      background: "linear-gradient(135deg, #fefce8 0%, #fef3c7 30%, #f3f4f6 70%, #e5e7eb 100%)",
      textColor: "#1f2937",
      accentColor: "#000000",
      highlightColor: "#ffffff",
    ...
    {
      id: 4,
      name: "Pearl + Typography Focus",
      description: "Pearl grays with clean, readable typography",
      background: "linear-gradient(135deg, #f8fafc 0%, #f1f5f9 30%, #e2e8f0 70%, #cbd5e1 100%)",
      textColor: "#1f2937",
      accentColor: "#000000",
      highlightColor: "#ffffff",
  ...
  const getTypographyStyle = (textStyle: string) => {
    switch (textStyle) {
      ...
      case 'mono':
        return { fontFamily: '"SF Mono", Monaco, "Cascadia Code", "Roboto Mono", monospace' };
      case 'display':
        return { fontFamily: '"Inter", -apple-system, BlinkMacSystemFont, sans-serif', fontWeight: '600' };
      default:
  ...
  return (
    <div style={containerStyle}>
      ...
      <div style={headerStyle}>
        <h1 style={titleStyle}>Sharp Black & White Designs</h1>
        <p style={subtitleStyle}>Warm neutrals and pearl grays with sharp black/white accents and typography focus</p>
