...
interface RealScreenshotPreviewProps {
  project: {
    _id: string;
    title: string;
    urlPath?: string;
...
export default function RealScreenshotPreview({ project, index }: RealScreenshotPreviewProps) {
