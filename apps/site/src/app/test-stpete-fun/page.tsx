...
export default function TestStPeteFunPage() {
  ...
  const designOptions = [
    ...
    {
      id: 4,
      name: "Warm + Yellow Spotlight",
      description: "Warm base with yellow gradient spotlight effect",
      background: "linear-gradient(135deg, #fefce8 0%, #fef3c7 30%, #f3f4f6 70%, #e5e7eb 100%)",
      textColor: "#1f2937",
      accentColor: "#fbbf24",
    ...
    {
      id: 5,
      name: "Pearl + Yellow Spotlight",
      description: "Pearl grays with yellow gradient highlights",
      background: "linear-gradient(135deg, #f8fafc 0%, #f1f5f9 30%, #e2e8f0 70%, #cbd5e1 100%)",
      textColor: "#1f2937",
      accentColor: "#fbbf24",
      highlightColor: "#f59e0b",
    ...
    {
      id: 6,
      name: "Logo-Inspired Fun",
      description: "Creative logo-style elements with playful typography",
  ...
  return (
    <div style={containerStyle}>
      ...
      <div style={headerStyle}>
        <h1 style={titleStyle}>Fun St. Pete Designs</h1>
        <p style={subtitleStyle}>Creative logo-inspired elements with yellow spotlights and playful typography</p>
          ...
          >
            ...
            >
              ...
              <div style={{
                ...
                right: '0',
                height: '4px',
                background: option.textStyle === 'logo' 
                  ? `linear-gradient(90deg, ${option.accentColor} 0%, ${option.highlightColor} 100%)`
                  : option.accentColor
              }}></div>
              
              {/* Fun elements for logo style */}
              {option.textStyle === 'logo' && (
                <>
                  <div style={{
                    position: 'absolute',
                    top: '1rem',
                  ...
                  <div style={{
                    ...
                    height: '12px',
                    borderRadius: '50%',
                    backgroundColor: option.highlightColor,
                    boxShadow: '0 2px 4px rgba(0, 0, 0, 0.2)'
                  }}></div>
                </>
              )}
              ...
              {/* Single accent dot for non-logo styles */}
              {option.textStyle !== 'logo' && (
                <div style={{
                  position: 'absolute',
                  top: '1rem',
      ...
      <div style={previewStyle}>
        ...
        >
          ...
          <div style={{
            ...
            {/* Photo Grid with Dynamic Highlights */}
            <div style={{
              display: 'grid',
              ...
              {Array.from({ length: 12 }).map((_, i) => (
                ...
                >
                  ...
                  <div style={{
                    ...
                    right: '0',
                    height: '3px',
                    background: designOptions[selectedOption - 1].textStyle === 'logo' 
                      ? `linear-gradient(90deg, ${designOptions[selectedOption - 1].accentColor} 0%, ${designOptions[selectedOption - 1].highlightColor} 100%)`
                      : designOptions[selectedOption - 1].accentColor,
            ...
            {/* Video Section with Dynamic Accents */}
            <div style={{
