...
`, MenuItem = forwardRef(function(t0, ref) {
  ...
  let t4;
  $[20] !== __unstable_subtitle || $[21] !== text ? (t4 = text && /* @__PURE__ */ jsxs(Stack, { flex: 1, space: __unstable_subtitle ? 1 : 2, paddingLeft: __unstable_subtitle ? 1 : 0, children: [
  ...
  let t7;
  $[32] !== tooltipProps ? (t7 = (children) => /* @__PURE__ */ jsx(Tooltip, { content: tooltipProps?.content, portal: !0, ...tooltipProps, children: /* @__PURE__ */ jsx("div", { children }) }), $[32] = tooltipProps, $[33] = t7) : t7 = $[33];
  ...
  let t12;
  $[38] !== disabled || $[39] !== ref || $[40] !== rest || $[41] !== t10 || $[42] !== t11 || $[43] !== t9 ? (t12 = /* @__PURE__ */ jsx(MenuItem$1, { disabled, paddingLeft: t9, paddingRight: 3, paddingY: t10, ref, ...rest, children: t11 }), $[38] = disabled, $[39] = ref, $[40] = rest, $[41] = t10, $[42] = t11, $[43] = t9, $[44] = t12) : t12 = $[44];
  let t13;
  return $[45] !== renderWrapper || $[46] !== t12 || $[47] !== t8 ? (t13 = /* @__PURE__ */ jsx(ConditionalWrapper, { condition: t8, wrapper: renderWrapper, children: t12 }), $[45] = renderWrapper, $[46] = t12, $[47] = t8, $[48] = t13) : t13 = $[48], t13;
