...
import { ReviewChangesContext, CommentsEnabledContext, ReferenceInputOptionsContext, PaneLayoutContext, PaneContext, DocumentPaneContext, PaneRouterContext, StructureToolContext, RawPerspectiveContext, PerspectiveContext, DocumentSheetListContext, DocumentChangeContext } from "sanity/_singletons";
...
function ArchivedReleaseDocumentBanner() {
  ...
  }, release = useMemo(() => archivedReleases.find((r) => getReleaseIdFromReleaseDocumentId(r._id) === params?.historyVersion), [archivedReleases, params?.historyVersion]), description = useMemo(() => release?.state === "published" ? "banners.published-release.description" : release && isCardinalityOneRelease(release) ? "banners.archived-scheduled-draft.description" : "banners.archived-release.description", [release]), title = release?.metadata.title || tCore("release.placeholder-untitled-release");
...
`, FormHeader = (t0) => {
  ...
  const $ = c(76), {
    ...
    title
  } = useDocumentTitle(), [patchChannel] = useState(_temp$l), isLocked = editState?.transactionSyncLock?.enabled, {
    t
  } = useTranslation(structureLocaleNamespace);
  let t0;
...
const FavoriteToggle = (t0) => {
  ...
  bb1: {
    if (params?.historyVersion) {
      let t123;
      $[37] === Symbol.for("react.memo_cache_sentinel") ? (t123 = /* @__PURE__ */ jsx(ArchivedReleaseDocumentBanner, {}), $[37] = t123) : t123 = $[37], t11 = t123;
      break bb1;
    }
    let t122;
    $[38] !== selectedPerspective ? (t122 = isReleaseDocument(selectedPerspective) && isReleaseScheduledOrScheduling(selectedPerspective), $[38] = selectedPerspective, $[39] = t122) : t122 = $[39];
    ...
    if ($[40] !== editState || $[41] !== schemaType || $[42] !== selectedPerspective || $[43] !== workspace.document.drafts.enabled ? (isSelectedPerspectiveWriteable = isPerspectiveWriteable({
      ...
      let t143;
      $[46] !== isSelectedPerspectiveWriteable.reason || $[47] !== isSelectedPerspectiveWriteable.result || $[48] !== schemaType || $[49] !== selectedPerspective ? (t143 = !isSelectedPerspectiveWriteable.result && /* @__PURE__ */ jsx(ChooseNewDocumentDestinationBanner, { schemaType, selectedPerspective, reason: isSelectedPerspectiveWriteable.reason }), $[46] = isSelectedPerspectiveWriteable.reason, $[47] = isSelectedPerspectiveWriteable.result, $[48] = schemaType, $[49] = selectedPerspective, $[50] = t143) : t143 = $[50], t11 = t143;
      break bb1;
    }
    if (documentInScheduledRelease) {
      const t143 = selectedPerspective;
      let t153;
      $[51] !== t143 ? (t153 = /* @__PURE__ */ jsx(ScheduledReleaseBanner, { currentRelease: t143 }), $[51] = t143, $[52] = t153) : t153 = $[52], t11 = t153;
      break bb1;
    }
    ...
    if (selectedPerspective === "drafts" && hasCardinalityOneReleases) {
      let t143;
      $[53] === Symbol.for("react.memo_cache_sentinel") ? (t143 = /* @__PURE__ */ jsx(ScheduledDraftOverrideBanner, {}), $[53] = t143) : t143 = $[53], t11 = t143;
      break bb1;
    }
    let t142;
    $[54] !== selectedPerspective ? (t142 = isSystemBundle(selectedPerspective), $[54] = selectedPerspective, $[55] = t142) : t142 = $[55];
    const isPinnedDraftOrPublish = t142, isCurrentVersionGoingToUnpublish = editState?.version && isGoingToUnpublish(editState?.version);
    if (displayed?._id && getVersionFromId(displayed._id) !== selectedReleaseId && ready && !isPinnedDraftOrPublish && isNewDocument(editState) === !1 && !isCurrentVersionGoingToUnpublish) {
      ...
      let t162;
      $[56] !== isScheduledRelease || $[57] !== t153 || $[58] !== value._id ? (t162 = /* @__PURE__ */ jsx(DocumentNotInReleaseBanner, { documentId: value._id, currentRelease: t153, isScheduledRelease }), $[56] = isScheduledRelease, $[57] = t153, $[58] = value._id, $[59] = t162) : t162 = $[59], t11 = t162;
      break bb1;
    }
    ...
    if (activeView.type === "form" && !selectedReleaseId && displayedHasObsoleteDraft.result) {
      if (displayedHasObsoleteDraft.reason === "DRAFT_MODEL_INACTIVE") {
        let t153;
        $[60] !== displayed || $[61] !== documentId || $[62] !== schemaType ? (t153 = /* @__PURE__ */ jsx(ObsoleteDraftBanner, { displayed, documentId, schemaType, i18nKey: "banners.obsolete-draft.draft-model-inactive.text" }), $[60] = displayed, $[61] = documentId, $[62] = schemaType, $[63] = t153) : t153 = $[63], t11 = t153;
        break bb1;
      }
      if (displayedHasObsoleteDraft.reason === "LIVE_EDIT_ACTIVE") {
        let t153;
        $[64] !== displayed || $[65] !== documentId || $[66] !== schemaType ? (t153 = /* @__PURE__ */ jsx(ObsoleteDraftBanner, { displayed, documentId, schemaType, i18nKey: "banners.live-edit-draft-banner.text", isEditBlocking: !0 }), $[64] = displayed, $[65] = documentId, $[66] = schemaType, $[67] = t153) : t153 = $[67], t11 = t153;
        break bb1;
      }
    }
    ...
    let t152;
    $[68] !== showCreateBanner ? (t152 = showCreateBanner && /* @__PURE__ */ jsx(CreateLinkedBanner, {}), $[68] = showCreateBanner, $[69] = t152) : t152 = $[69];
    let t16;
    $[70] !== permissions?.granted || $[71] !== requiredPermission ? (t16 = !permissions?.granted && /* @__PURE__ */ jsx(InsufficientPermissionBanner, { requiredPermission }), $[70] = permissions?.granted, $[71] = requiredPermission, $[72] = t16) : t16 = $[72];
    let t17, t18, t19, t20, t21, t22;
    $[73] === Symbol.for("react.memo_cache_sentinel") ? (t17 = /* @__PURE__ */ jsx(RevisionNotFoundBanner, {}), t18 = /* @__PURE__ */ jsx(ReferenceChangedBanner, {}), t19 = /* @__PURE__ */ jsx(DeprecatedDocumentTypeBanner, {}), t20 = /* @__PURE__ */ jsx(CanvasLinkedBanner, {}), t21 = /* @__PURE__ */ jsx(DeletedDocumentBanners, {}), t22 = /* @__PURE__ */ jsx(UnpublishedDocumentBanner, {}), $[73] = t17, $[74] = t18, $[75] = t19, $[76] = t20, $[77] = t21, $[78] = t22) : (t17 = $[73], t18 = $[74], t19 = $[75], t20 = $[76], t21 = $[77], t22 = $[78]);
    const t23 = displayed?._id ?? documentId;
    let t24;
    $[79] !== isPinnedDraftOrPublish || $[80] !== t23 ? (t24 = /* @__PURE__ */ jsx(OpenReleaseToEditBanner, { documentId: t23, isPinnedDraftOrPublished: isPinnedDraftOrPublish }), $[79] = isPinnedDraftOrPublish, $[80] = t23, $[81] = t24) : t24 = $[81];
    let t25;
    $[82] !== t152 || $[83] !== t16 || $[84] !== t24 ? (t25 = /* @__PURE__ */ jsxs(Fragment, { children: [
      t152,
      t16,
      t17,
      t18,
  ...
  let t13;
  $[88] !== activeViewNode || $[89] !== banners || $[90] !== documentScrollElement || $[91] !== footer || $[92] !== formViewHidden || $[93] !== inspectDialog || $[94] !== layoutCollapsed || $[95] !== margins || $[96] !== portalElement || $[97] !== portalElements || $[98] !== showFormView ? (t13 = showFormView && /* @__PURE__ */ jsxs(Flex, { height: "fill", direction: "column", width: "fill", flex: 2, children: [
  ...
  let t14;
  $[100] !== documentId || $[101] !== rootElement || $[102] !== schemaType || $[103] !== showInspector ? (t14 = showInspector && /* @__PURE__ */ jsx(BoundaryElementProvider, { element: rootElement, children: /* @__PURE__ */ jsx(DocumentInspectorPanel, { documentId, documentType: schemaType.name, flex: 1 }) }), $[100] = documentId, $[101] = rootElement, $[102] = schemaType, $[103] = showInspector, $[104] = t14) : t14 = $[104];
  let t15;
  return $[105] !== t13 || $[106] !== t14 ? (t15 = /* @__PURE__ */ jsx(PaneContent, { children: /* @__PURE__ */ jsxs(Flex, { height: "fill", children: [
    t13,
    t14
...
function usePreviewUrl(value) {
  ...
  return $[4] !== resolveProductionUrl ? (t3 = subject.asObservable().pipe(distinctUntilChanged$1(), debounceTime(500), switchMap((document2) => isSanityDocument(document2) ? from(resolveProductionUrl({
    document: document2
  })) : of(void 0)), distinctUntilChanged$1(), catchError$1(_temp$d)), $[4] = resolveProductionUrl, $[5] = t3) : t3 = $[5], useObservable(t3);
}
...
const DocumentPaneProvider = memo((props) => {
  const {
    ...
    data: releases = []
  } = useActiveReleases(), getDocumentVersionType = useCallback(() => {
    let version;
    switch (!0) {
      case !!params.rev:
        version = "revision";
    ...
    return version;
  }, [params.rev, selectedReleaseId, value_0._id, selectedPerspectiveName, draftsEnabled, releases]), actionsPerspective = useMemo(() => getDocumentVersionType(), [getDocumentVersionType]), documentActionsProps = useMemo(() => ({
...
const DocumentPerspectiveResetHandler = (t0) => {
  const $ = c(13), {
    documentId
  } = t0, rawContext = useContext(RawPerspectiveContext);
  let t1;
  $[0] !== documentId ? (t1 = {
    documentId
  }, $[0] = documentId, $[1] = t1) : t1 = $[1];
  ...
  let t3;
  return $[7] !== documentId || $[8] !== documentVersions || $[9] !== documentVersionsLoading || $[10] !== rawContext || $[11] !== setPerspective ? (t3 = [documentId, rawContext, documentVersions, documentVersionsLoading, setPerspective], $[7] = documentId, $[8] = documentVersions, $[9] = documentVersionsLoading, $[10] = rawContext, $[11] = setPerspective, $[12] = t3) : t3 = $[12], useEffect(t2, t3), null;
};
function DocumentPerspectiveProvider(t0) {
  const $ = c(21), {
    children,
    documentId
  } = t0, rawContext = useContext(RawPerspectiveContext), mappedContext = useContext(PerspectiveContext);
  let t1;
  $[0] !== documentId ? (t1 = {
    documentId
  }, $[0] = documentId, $[1] = t1) : t1 = $[1];
  const {
    ...
    enabled: isDraftModelEnabled
  } = t3, defaultPerspective = isDraftModelEnabled ? LATEST : PUBLISHED;
  let t4;
  bb0: {
  ...
  let t5;
  $[15] !== documentId ? (t5 = /* @__PURE__ */ jsx(DocumentPerspectiveResetHandler, { documentId }), $[15] = documentId, $[16] = t5) : t5 = $[16];
  let t6;
  return $[17] !== children || $[18] !== t5 || $[19] !== value ? (t6 = /* @__PURE__ */ jsxs(PerspectiveContext.Provider, { value, children: [
    children,
    t5
...
const DocumentPaneProviderWrapper = memo((props) => {
  const $ = c(8), source = useSource();
  let t0;
  $[0] !== props.itemId ? (t0 = getPublishedId(props.itemId), $[0] = props.itemId, $[1] = t0) : t0 = $[1];
  const documentId = t0;
  let t1;
  $[2] !== props || $[3] !== source.beta?.eventsAPI?.documents ? (t1 = source.beta?.eventsAPI?.documents ? /* @__PURE__ */ jsx(DocumentEventsPane, { ...props }) : /* @__PURE__ */ jsx(DocumentPaneWithLegacyTimelineStore, { ...props }), $[2] = props, $[3] = source.beta?.eventsAPI?.documents, $[4] = t1) : t1 = $[4];
  let t2;
  return $[5] !== documentId || $[6] !== t1 ? (t2 = /* @__PURE__ */ jsx(DocumentPerspectiveProvider, { documentId, children: t1 }), $[5] = documentId, $[6] = t1, $[7] = t2) : t2 = $[7], t2;
});
