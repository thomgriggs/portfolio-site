...
function usePathSyncChannel(t0) {
  ...
  if ($[3] !== id || $[4] !== syncChannel) {
    ...
    $[6] !== id ? (t32 = (t4) => {
      ...
      return source !== id;
    }, $[6] = id, $[7] = t32) : t32 = $[7], t2 = syncChannel.pipe(rxjs.distinctUntilChanged(_temp$q), rxjs.filter(t32), rxjs.map(_temp2$9)), $[3] = id, $[4] = syncChannel, $[5] = t2;
  } else
    t2 = $[5];
  const path = t2;
  let t3;
...
`, FormHeader = (t0) => {
  ...
  let t14;
  $[64] !== setRef || $[65] !== t12 || $[66] !== t13 ? (t14 = /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { as: "form", onSubmit: preventDefault, ref: setRef, "data-testid": "form-view", "data-read-only": t12, children: t13 }), $[64] = setRef, $[65] = t12, $[66] = t13, $[67] = t14) : t14 = $[67];
  let t15;
  $[68] !== margins || $[69] !== t14 ? (t15 = /* @__PURE__ */ jsxRuntime.jsx(sanity.PresenceOverlay, { margins, children: t14 }), $[68] = margins, $[69] = t14, $[70] = t15) : t15 = $[70];
  let t16;
  return $[71] !== hidden || $[72] !== t15 ? (t16 = /* @__PURE__ */ jsxRuntime.jsx(ui.Container, { hidden, paddingX: 4, paddingTop: 5, paddingBottom: 9, sizing: "border", width: 1, children: t15 }), $[71] = hidden, $[72] = t15, $[73] = t16) : t16 = $[73], t16;
});
...
const FavoriteToggle = (t0) => {
  ...
  bb1: {
    ...
    if (documentInScheduledRelease) {
      ...
      let t142;
      $[48] !== t133 ? (t142 = /* @__PURE__ */ jsxRuntime.jsx(ScheduledReleaseBanner, { currentRelease: t133 }), $[48] = t133, $[49] = t142) : t142 = $[49], t10 = t142;
      break bb1;
    }
    let t132;
    ...
    if (displayed?._id && sanity.getVersionFromId(displayed._id) !== selectedReleaseId && ready && !isPinnedDraftOrPublish && sanity.isNewDocument(editState) === !1 && !isCurrentVersionGoingToUnpublish) {
      ...
      let t152;
      $[52] !== isScheduledRelease || $[53] !== t142 || $[54] !== value._id ? (t152 = /* @__PURE__ */ jsxRuntime.jsx(DocumentNotInReleaseBanner, { documentId: value._id, currentRelease: t142, isScheduledRelease }), $[52] = isScheduledRelease, $[53] = t142, $[54] = value._id, $[55] = t152) : t152 = $[55], t10 = t152;
      break bb1;
    }
    ...
    if (activeView.type === "form" && !selectedReleaseId && displayedHasObsoleteDraft.result) {
      if (displayedHasObsoleteDraft.reason === "DRAFT_MODEL_INACTIVE") {
        let t142;
        $[56] !== displayed || $[57] !== documentId || $[58] !== schemaType ? (t142 = /* @__PURE__ */ jsxRuntime.jsx(ObsoleteDraftBanner, { displayed, documentId, schemaType, i18nKey: "banners.obsolete-draft.draft-model-inactive.text" }), $[56] = displayed, $[57] = documentId, $[58] = schemaType, $[59] = t142) : t142 = $[59], t10 = t142;
        break bb1;
      }
      if (displayedHasObsoleteDraft.reason === "LIVE_EDIT_ACTIVE") {
        let t142;
        $[60] !== displayed || $[61] !== documentId || $[62] !== schemaType ? (t142 = /* @__PURE__ */ jsxRuntime.jsx(ObsoleteDraftBanner, { displayed, documentId, schemaType, i18nKey: "banners.live-edit-draft-banner.text", isEditBlocking: !0 }), $[60] = displayed, $[61] = documentId, $[62] = schemaType, $[63] = t142) : t142 = $[63], t10 = t142;
        break bb1;
      }
    }
    ...
    let t14;
    $[64] !== showCreateBanner ? (t14 = showCreateBanner && /* @__PURE__ */ jsxRuntime.jsx(CreateLinkedBanner, {}), $[64] = showCreateBanner, $[65] = t14) : t14 = $[65];
    let t15;
    ...
    let t24;
    $[78] !== t14 || $[79] !== t15 || $[80] !== t23 ? (t24 = /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
      t14,
      t15,
      t16,
      t17,
  ...
  let t11;
  $[82] !== activeViewNode || $[83] !== banners || $[84] !== documentScrollElement || $[85] !== footer || $[86] !== formViewHidden || $[87] !== inspectDialog || $[88] !== layoutCollapsed || $[89] !== margins || $[90] !== portalElement || $[91] !== showFormView ? (t11 = showFormView && /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { height: "fill", direction: "column", width: "fill", flex: 2, children: [
  ...
  let t12;
  $[93] !== documentId || $[94] !== rootElement || $[95] !== schemaType || $[96] !== showInspector ? (t12 = showInspector && /* @__PURE__ */ jsxRuntime.jsx(ui.BoundaryElementProvider, { element: rootElement, children: /* @__PURE__ */ jsxRuntime.jsx(DocumentInspectorPanel, { documentId, documentType: schemaType.name, flex: 1 }) }), $[93] = documentId, $[94] = rootElement, $[95] = schemaType, $[96] = showInspector, $[97] = t12) : t12 = $[97];
  let t13;
  return $[98] !== t11 || $[99] !== t12 ? (t13 = /* @__PURE__ */ jsxRuntime.jsx(PaneContent, { children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { height: "fill", children: [
    t11,
    t12
...
const DocumentStatusBarActionsInner = React.memo(function(props) {
  ...
  let t3;
  $[15] !== disabled || $[16] !== firstActionState || $[17] !== showFirstActionButton || $[18] !== tooltipContent ? (t3 = showFirstActionButton && /* @__PURE__ */ jsxRuntime.jsx(ui.LayerProvider, { zOffset: 200, children: /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.Tooltip, { disabled: !tooltipContent, content: tooltipContent, placement: "top", children: /* @__PURE__ */ jsxRuntime.jsx(ui.Stack, { children: /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.Button, { "data-testid": `action-${toLowerCaseNoSpaces(firstActionState.label)}`, disabled: disabled || !!firstActionState.disabled, icon: firstActionState.icon, onClick: firstActionState.onHandle, ref: setButtonElement, text: firstActionState.label, tone: firstActionState.tone || "primary" }) }) }) }), $[15] = disabled, $[16] = firstActionState, $[17] = showFirstActionButton, $[18] = tooltipContent, $[19] = t3) : t3 = $[19];
  let t4;
  $[20] !== disabled || $[21] !== sideMenuItems ? (t4 = sideMenuItems.length > 0 && /* @__PURE__ */ jsxRuntime.jsx(ActionMenuButton, { actionStates: sideMenuItems, disabled }), $[20] = disabled, $[21] = sideMenuItems, $[22] = t4) : t4 = $[22];
  let t5;
  $[23] !== buttonElement || $[24] !== firstActionState ? (t5 = firstActionState && firstActionState.dialog && /* @__PURE__ */ jsxRuntime.jsx(ActionStateDialog, { dialog: firstActionState.dialog, referenceElement: buttonElement }), $[23] = buttonElement, $[24] = firstActionState, $[25] = t5) : t5 = $[25];
  let t6;
  return $[26] !== t2 || $[27] !== t3 || $[28] !== t4 || $[29] !== t5 ? (t6 = /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { align: "center", gap: 1, children: [
    t2,
    t3,
    t4,
    t5
