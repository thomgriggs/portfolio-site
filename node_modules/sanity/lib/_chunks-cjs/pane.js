...
function usePathSyncChannel(t0) {
  ...
  if ($[3] !== id || $[4] !== syncChannel) {
    ...
    $[6] !== id ? (t32 = (t4) => {
      ...
      return source !== id;
    }, $[6] = id, $[7] = t32) : t32 = $[7], t2 = syncChannel.pipe(rxjs.distinctUntilChanged(_temp$q), rxjs.filter(t32), rxjs.map(_temp2$a)), $[3] = id, $[4] = syncChannel, $[5] = t2;
  } else
    t2 = $[5];
  const path = t2;
  let t3;
...
function InsufficientPermissionBanner(t0) {
  ...
  const listFormat = sanity.useListFormat(t1), {
    t
  } = sanity.useTranslation(StructureToolProvider.structureLocaleNamespace), telemetry2 = react.useTelemetry(), roleTitles = currentUserRoles.map(_temp$n), roles = listFormat.formatToParts(roleTitles).map(_temp2$8);
  let t2;
  $[1] !== roles ? (t2 = {
...
function ArchivedReleaseDocumentBanner() {
  ...
  }, release = React.useMemo(() => archivedReleases.find((r) => sanity.getReleaseIdFromReleaseDocumentId(r._id) === params?.historyVersion), [archivedReleases, params?.historyVersion]), description = React.useMemo(() => release?.state === "published" ? "banners.published-release.description" : release && sanity.isCardinalityOneRelease(release) ? "banners.archived-scheduled-draft.description" : "banners.archived-release.description", [release]), title = release?.metadata.title || tCore("release.placeholder-untitled-release");
...
`, CANVAS_IMAGE_URL = "https://cdn.sanity.io/images/pyrmmpch/production/b47224e2f3a7d1747e43b9da1ac31739250e628b-632x376.png", CANVAS_APP_NAME = "Canvas", CanvasPopoverContent = (t0) => {
  ...
  let t2;
  $[6] === Symbol.for("react.memo_cache_sentinel") ? (t2 = () => setOpen(_temp$m), $[6] = t2) : t2 = $[6];
...
`, FormHeader = (t0) => {
  ...
  const $ = reactCompilerRuntime.c(76), {
    ...
    title
  } = useDocumentTitle(), [patchChannel] = React.useState(_temp$l), isLocked = editState?.transactionSyncLock?.enabled, {
    t
  } = sanity.useTranslation(StructureToolProvider.structureLocaleNamespace);
  let t0;
...
const FavoriteToggle = (t0) => {
  ...
  let t10;
  $[34] !== displayed || $[35] !== documentId ? (t10 = {
    displayed,
    documentId
  }, $[34] = displayed, $[35] = documentId, $[36] = t10) : t10 = $[36];
  const filteredReleases = useFilteredReleases(t10);
  let t11;
  bb1: {
    if (params?.historyVersion) {
      let t123;
      $[37] === Symbol.for("react.memo_cache_sentinel") ? (t123 = /* @__PURE__ */ jsxRuntime.jsx(ArchivedReleaseDocumentBanner, {}), $[37] = t123) : t123 = $[37], t11 = t123;
      break bb1;
    }
    let t122;
    $[38] !== selectedPerspective ? (t122 = sanity.isReleaseDocument(selectedPerspective) && sanity.isReleaseScheduledOrScheduling(selectedPerspective), $[38] = selectedPerspective, $[39] = t122) : t122 = $[39];
    const isScheduledRelease = t122, documentInScheduledRelease = !!(isScheduledRelease && displayed?._id && sanity.getVersionFromId(displayed?._id) === selectedReleaseId);
    let isSelectedPerspectiveWriteable, t132;
    if ($[40] !== editState || $[41] !== schemaType || $[42] !== selectedPerspective || $[43] !== workspace.document.drafts.enabled ? (isSelectedPerspectiveWriteable = sanity.isPerspectiveWriteable({
      selectedPerspective,
      ...
      isSelectedPerspectiveWriteable,
      editState
    }), $[40] = editState, $[41] = schemaType, $[42] = selectedPerspective, $[43] = workspace.document.drafts.enabled, $[44] = isSelectedPerspectiveWriteable, $[45] = t132) : (isSelectedPerspectiveWriteable = $[44], t132 = $[45]), t132) {
      let t143;
      $[46] !== isSelectedPerspectiveWriteable.reason || $[47] !== isSelectedPerspectiveWriteable.result || $[48] !== schemaType || $[49] !== selectedPerspective ? (t143 = !isSelectedPerspectiveWriteable.result && /* @__PURE__ */ jsxRuntime.jsx(ChooseNewDocumentDestinationBanner, { schemaType, selectedPerspective, reason: isSelectedPerspectiveWriteable.reason }), $[46] = isSelectedPerspectiveWriteable.reason, $[47] = isSelectedPerspectiveWriteable.result, $[48] = schemaType, $[49] = selectedPerspective, $[50] = t143) : t143 = $[50], t11 = t143;
      break bb1;
    }
    if (documentInScheduledRelease) {
      const t143 = selectedPerspective;
      let t153;
      $[51] !== t143 ? (t153 = /* @__PURE__ */ jsxRuntime.jsx(ScheduledReleaseBanner, { currentRelease: t143 }), $[51] = t143, $[52] = t153) : t153 = $[52], t11 = t153;
      break bb1;
    }
    ...
    if (selectedPerspective === "drafts" && hasCardinalityOneReleases) {
      let t143;
      $[53] === Symbol.for("react.memo_cache_sentinel") ? (t143 = /* @__PURE__ */ jsxRuntime.jsx(ScheduledDraftOverrideBanner, {}), $[53] = t143) : t143 = $[53], t11 = t143;
      break bb1;
    }
    let t142;
    $[54] !== selectedPerspective ? (t142 = sanity.isSystemBundle(selectedPerspective), $[54] = selectedPerspective, $[55] = t142) : t142 = $[55];
    const isPinnedDraftOrPublish = t142, isCurrentVersionGoingToUnpublish = editState?.version && sanity.isGoingToUnpublish(editState?.version);
    if (displayed?._id && sanity.getVersionFromId(displayed._id) !== selectedReleaseId && ready && !isPinnedDraftOrPublish && sanity.isNewDocument(editState) === !1 && !isCurrentVersionGoingToUnpublish) {
      ...
      let t162;
      $[56] !== isScheduledRelease || $[57] !== t153 || $[58] !== value._id ? (t162 = /* @__PURE__ */ jsxRuntime.jsx(DocumentNotInReleaseBanner, { documentId: value._id, currentRelease: t153, isScheduledRelease }), $[56] = isScheduledRelease, $[57] = t153, $[58] = value._id, $[59] = t162) : t162 = $[59], t11 = t162;
      break bb1;
    }
    ...
    if (activeView.type === "form" && !selectedReleaseId && displayedHasObsoleteDraft.result) {
      if (displayedHasObsoleteDraft.reason === "DRAFT_MODEL_INACTIVE") {
        let t153;
        $[60] !== displayed || $[61] !== documentId || $[62] !== schemaType ? (t153 = /* @__PURE__ */ jsxRuntime.jsx(ObsoleteDraftBanner, { displayed, documentId, schemaType, i18nKey: "banners.obsolete-draft.draft-model-inactive.text" }), $[60] = displayed, $[61] = documentId, $[62] = schemaType, $[63] = t153) : t153 = $[63], t11 = t153;
        break bb1;
      }
      if (displayedHasObsoleteDraft.reason === "LIVE_EDIT_ACTIVE") {
        let t153;
        $[64] !== displayed || $[65] !== documentId || $[66] !== schemaType ? (t153 = /* @__PURE__ */ jsxRuntime.jsx(ObsoleteDraftBanner, { displayed, documentId, schemaType, i18nKey: "banners.live-edit-draft-banner.text", isEditBlocking: !0 }), $[64] = displayed, $[65] = documentId, $[66] = schemaType, $[67] = t153) : t153 = $[67], t11 = t153;
        break bb1;
      }
    }
    ...
    let t152;
    $[68] !== showCreateBanner ? (t152 = showCreateBanner && /* @__PURE__ */ jsxRuntime.jsx(CreateLinkedBanner, {}), $[68] = showCreateBanner, $[69] = t152) : t152 = $[69];
    let t16;
    $[70] !== permissions?.granted || $[71] !== requiredPermission ? (t16 = !permissions?.granted && /* @__PURE__ */ jsxRuntime.jsx(InsufficientPermissionBanner, { requiredPermission }), $[70] = permissions?.granted, $[71] = requiredPermission, $[72] = t16) : t16 = $[72];
    let t17, t18, t19, t20, t21, t22;
    $[73] === Symbol.for("react.memo_cache_sentinel") ? (t17 = /* @__PURE__ */ jsxRuntime.jsx(RevisionNotFoundBanner, {}), t18 = /* @__PURE__ */ jsxRuntime.jsx(ReferenceChangedBanner, {}), t19 = /* @__PURE__ */ jsxRuntime.jsx(DeprecatedDocumentTypeBanner, {}), t20 = /* @__PURE__ */ jsxRuntime.jsx(CanvasLinkedBanner, {}), t21 = /* @__PURE__ */ jsxRuntime.jsx(DeletedDocumentBanners, {}), t22 = /* @__PURE__ */ jsxRuntime.jsx(UnpublishedDocumentBanner, {}), $[73] = t17, $[74] = t18, $[75] = t19, $[76] = t20, $[77] = t21, $[78] = t22) : (t17 = $[73], t18 = $[74], t19 = $[75], t20 = $[76], t21 = $[77], t22 = $[78]);
    const t23 = displayed?._id ?? documentId;
    let t24;
    $[79] !== isPinnedDraftOrPublish || $[80] !== t23 ? (t24 = /* @__PURE__ */ jsxRuntime.jsx(OpenReleaseToEditBanner, { documentId: t23, isPinnedDraftOrPublished: isPinnedDraftOrPublish }), $[79] = isPinnedDraftOrPublish, $[80] = t23, $[81] = t24) : t24 = $[81];
    let t25;
    $[82] !== t152 || $[83] !== t16 || $[84] !== t24 ? (t25 = /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
      t152,
      t16,
      t17,
      t18,
      ...
      t22,
      t24
    ] }), $[82] = t152, $[83] = t16, $[84] = t24, $[85] = t25) : t25 = $[85], t11 = t25;
  }
  const banners = t11;
  let t12;
  $[86] !== documentScrollElement ? (t12 = {
    documentScrollElement
  }, $[86] = documentScrollElement, $[87] = t12) : t12 = $[87];
  const portalElements = t12, showFormView = features.resizablePanes || !showInspector;
  let t13;
  $[88] !== activeViewNode || $[89] !== banners || $[90] !== documentScrollElement || $[91] !== footer || $[92] !== formViewHidden || $[93] !== inspectDialog || $[94] !== layoutCollapsed || $[95] !== margins || $[96] !== portalElement || $[97] !== portalElements || $[98] !== showFormView ? (t13 = showFormView && /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { height: "fill", direction: "column", width: "fill", flex: 2, children: [
    ...
    footer
  ] }), $[88] = activeViewNode, $[89] = banners, $[90] = documentScrollElement, $[91] = footer, $[92] = formViewHidden, $[93] = inspectDialog, $[94] = layoutCollapsed, $[95] = margins, $[96] = portalElement, $[97] = portalElements, $[98] = showFormView, $[99] = t13) : t13 = $[99];
  let t14;
  $[100] !== documentId || $[101] !== rootElement || $[102] !== schemaType || $[103] !== showInspector ? (t14 = showInspector && /* @__PURE__ */ jsxRuntime.jsx(ui.BoundaryElementProvider, { element: rootElement, children: /* @__PURE__ */ jsxRuntime.jsx(DocumentInspectorPanel, { documentId, documentType: schemaType.name, flex: 1 }) }), $[100] = documentId, $[101] = rootElement, $[102] = schemaType, $[103] = showInspector, $[104] = t14) : t14 = $[104];
  let t15;
  return $[105] !== t13 || $[106] !== t14 ? (t15 = /* @__PURE__ */ jsxRuntime.jsx(PaneContent, { children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { height: "fill", children: [
    t13,
    t14
  ] }) }), $[105] = t13, $[106] = t14, $[107] = t15) : t15 = $[107], t15;
};
...
const STATUS_DICTIONARY = {
  ...
  const $ = reactCompilerRuntime.c(8), {
    timelineStore
  } = useDocumentPane(), chunks = sanity.useTimelineSelector(timelineStore, _temp$g), loading = sanity.useTimelineSelector(timelineStore, _temp2$5), event = chunks?.[0];
  if (!event && loading) {
    let t02;
    return $[0] === Symbol.for("react.memo_cache_sentinel") ? (t02 = /* @__PURE__ */ jsxRuntime.jsx(ButtonSkeleton, {}), $[0] = t02) : t02 = $[0], t02;
  }
...
const useDocumentLastRev = (documentId, documentType) => {
  ...
  const timelineStore = sanity.useTimelineStore(t0), lastNonDeletedRevId = sanity.useTimelineSelector(timelineStore, _temp$e);
  let t1, t2;
...
function usePreviewUrl(value) {
  ...
  return $[4] !== resolveProductionUrl ? (t3 = subject.asObservable().pipe(operators.distinctUntilChanged(), operators.debounceTime(500), operators.switchMap((document2) => isSanityDocument(document2) ? rxjs.from(resolveProductionUrl({
    document: document2
  })) : rxjs.of(void 0)), operators.distinctUntilChanged(), operators.catchError(_temp$d)), $[4] = resolveProductionUrl, $[5] = t3) : t3 = $[5], reactRx.useObservable(t3);
}
...
const DocumentPaneProvider = React.memo((props) => {
  const {
    ...
    data: releases = []
  } = sanity.useActiveReleases(), getDocumentVersionType = React.useCallback(() => {
    let version;
    switch (!0) {
      case !!params.rev:
        version = "revision";
    ...
    return version;
  }, [params.rev, selectedReleaseId, value_0._id, selectedPerspectiveName, draftsEnabled, releases]), actionsPerspective = React.useMemo(() => getDocumentVersionType(), [getDocumentVersionType]), documentActionsProps = React.useMemo(() => ({
...
const DocumentPerspectiveResetHandler = (t0) => {
  const $ = reactCompilerRuntime.c(13), {
    documentId
  } = t0, rawContext = React.useContext(_singletons.RawPerspectiveContext);
  let t1;
  $[0] !== documentId ? (t1 = {
    documentId
  }, $[0] = documentId, $[1] = t1) : t1 = $[1];
  ...
  } = sanity.useDocumentVersions(t1), setPerspective = sanity.useSetPerspective();
  let t2;
  $[2] !== documentVersions || $[3] !== documentVersionsLoading || $[4] !== rawContext || $[5] !== setPerspective ? (t2 = () => {
    if (!(documentVersionsLoading || !rawContext || !sanity.isCardinalityOnePerspective(rawContext.selectedPerspective))) {
  ...
  let t3;
  return $[7] !== documentId || $[8] !== documentVersions || $[9] !== documentVersionsLoading || $[10] !== rawContext || $[11] !== setPerspective ? (t3 = [documentId, rawContext, documentVersions, documentVersionsLoading, setPerspective], $[7] = documentId, $[8] = documentVersions, $[9] = documentVersionsLoading, $[10] = rawContext, $[11] = setPerspective, $[12] = t3) : t3 = $[12], React.useEffect(t2, t3), null;
};
function DocumentPerspectiveProvider(t0) {
  const $ = reactCompilerRuntime.c(21), {
    children,
    documentId
  } = t0, rawContext = React.useContext(_singletons.RawPerspectiveContext), mappedContext = React.useContext(_singletons.PerspectiveContext);
  let t1;
  $[0] !== documentId ? (t1 = {
    documentId
  }, $[0] = documentId, $[1] = t1) : t1 = $[1];
  const {
    ...
    enabled: isDraftModelEnabled
  } = t3, defaultPerspective = isDraftModelEnabled ? sanity.LATEST : sanity.PUBLISHED;
  let t4;
  bb0: {
    ...
    if (!sanity.isCardinalityOnePerspective(rawContext.selectedPerspective)) {
      t4 = mappedContext;
      break bb0;
    }
  ...
  let t5;
  $[15] !== documentId ? (t5 = /* @__PURE__ */ jsxRuntime.jsx(DocumentPerspectiveResetHandler, { documentId }), $[15] = documentId, $[16] = t5) : t5 = $[16];
  let t6;
  return $[17] !== children || $[18] !== t5 || $[19] !== value ? (t6 = /* @__PURE__ */ jsxRuntime.jsxs(_singletons.PerspectiveContext.Provider, { value, children: [
    children,
    t5
...
const DocumentPaneProviderWrapper = React.memo((props) => {
  const $ = reactCompilerRuntime.c(8), source = sanity.useSource();
  let t0;
  $[0] !== props.itemId ? (t0 = sanity.getPublishedId(props.itemId), $[0] = props.itemId, $[1] = t0) : t0 = $[1];
  const documentId = t0;
  let t1;
  $[2] !== props || $[3] !== source.beta?.eventsAPI?.documents ? (t1 = source.beta?.eventsAPI?.documents ? /* @__PURE__ */ jsxRuntime.jsx(DocumentEventsPane, { ...props }) : /* @__PURE__ */ jsxRuntime.jsx(DocumentPaneWithLegacyTimelineStore, { ...props }), $[2] = props, $[3] = source.beta?.eventsAPI?.documents, $[4] = t1) : t1 = $[4];
  let t2;
  return $[5] !== documentId || $[6] !== t1 ? (t2 = /* @__PURE__ */ jsxRuntime.jsx(DocumentPerspectiveProvider, { documentId, children: t1 }), $[5] = documentId, $[6] = t1, $[7] = t2) : t2 = $[7], t2;
});
