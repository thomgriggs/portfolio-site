...
var isHotkeyEsm = require("is-hotkey-esm"), isEqual = require("lodash/isEqual.js");
...
function useRouterPanesStream() {
  ...
  let t0;
  $[0] !== routerStateSubject ? (t0 = routerStateSubject.asObservable().pipe(operators.map(_temp2$3)), $[0] = routerStateSubject, $[1] = t0) : t0 = $[1];
  ...
  }, t2 = [routerState, routerStateSubject], $[2] = routerState, $[3] = routerStateSubject, $[4] = t1, $[5] = t2) : (t1 = $[4], t2 = $[5]), React.useEffect(t1, t2), routerPanes$;
}
...
function StructureError(t0) {
  ...
  const {
    ...
    t
  } = sanity.useTranslation(StructureToolProvider.structureLocaleNamespace), stack = cause?.stack || error.stack;
  let t1;
  $[0] !== cause || $[1] !== error.message || $[2] !== stack ? (t1 = stack && !(cause instanceof StructureToolProvider.SerializeError) && !error.message.includes("Module build failed:"), $[0] = cause, $[1] = error.message, $[2] = stack, $[3] = t1) : t1 = $[3];
  const showStack = t1;
  ...
  if ($[4] !== cause || $[5] !== error.helpId || $[6] !== t) {
    ...
    helpId = cause instanceof StructureToolProvider.SerializeError && cause.helpId || error.helpId, handleReload = _temp$3, T2 = ui.Card, t10 = "fill", t11 = "auto", t12 = 4, t13 = "border", t14 = "critical", T1 = ui.Container;
    let t152;
    $[25] !== t ? (t152 = t("structure-error.header.text"), $[25] = t, $[26] = t152) : t152 = $[26], $[27] !== t152 ? (t9 = /* @__PURE__ */ jsxRuntime.jsx(ui.Heading, { as: "h2", children: t152 }), $[27] = t152, $[28] = t9) : t9 = $[28], T0 = ui.Card, t2 = 4, t3 = 4, t4 = 2, t5 = "auto", t6 = 1, t7 = "inherit", t8 = path.length > 0 && /* @__PURE__ */ jsxRuntime.jsxs(ui.Stack, { space: 2, children: [
  ...
  let t16;
  $[31] !== t15 ? (t16 = /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: 1, weight: "medium", children: t15 }), $[31] = t15, $[32] = t16) : t16 = $[32];
  let t17;
  ...
  let t18;
  $[37] !== t17 ? (t18 = /* @__PURE__ */ jsxRuntime.jsx(ui.Code, { children: t17 }), $[37] = t17, $[38] = t18) : t18 = $[38];
  let t19;
  $[39] !== t16 || $[40] !== t18 ? (t19 = /* @__PURE__ */ jsxRuntime.jsxs(ui.Stack, { marginTop: 4, space: 2, children: [
    t16,
    t18
  ] }), $[39] = t16, $[40] = t18, $[41] = t19) : t19 = $[41];
  let t20;
  $[42] !== helpId || $[43] !== t ? (t20 = helpId && /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { marginTop: 4, children: /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { children: /* @__PURE__ */ jsxRuntime.jsx("a", { href: generateHelpUrl_esm.generateHelpUrl(helpId), rel: "noopener noreferrer", target: "_blank", children: t("structure-error.docs-link.text") }) }) }), $[42] = helpId, $[43] = t, $[44] = t20) : t20 = $[44];
  let t21;
  $[45] !== t ? (t21 = t("structure-error.reload-button.text"), $[45] = t, $[46] = t21) : t21 = $[46];
  let t22;
  $[47] !== handleReload || $[48] !== t21 ? (t22 = /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { marginTop: 4, children: /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.Button, { text: t21, icon: icons.SyncIcon, tone: "primary", onClick: handleReload }) }), $[47] = handleReload, $[48] = t21, $[49] = t22) : t22 = $[49];
  let t23;
  $[50] !== T0 || $[51] !== t19 || $[52] !== t2 || $[53] !== t20 || $[54] !== t22 || $[55] !== t3 || $[56] !== t4 || $[57] !== t5 || $[58] !== t6 || $[59] !== t7 || $[60] !== t8 ? (t23 = /* @__PURE__ */ jsxRuntime.jsxs(T0, { marginTop: t2, padding: t3, radius: t4, overflow: t5, shadow: t6, tone: t7, children: [
    t8,
    t19,
    t20,
    t22
  ...
  let t24;
  $[62] !== T1 || $[63] !== t23 || $[64] !== t9 ? (t24 = /* @__PURE__ */ jsxRuntime.jsxs(T1, { children: [
    t9,
    t23
  ] }), $[62] = T1, $[63] = t23, $[64] = t9, $[65] = t24) : t24 = $[65];
  let t25;
  return $[66] !== T2 || $[67] !== t10 || $[68] !== t11 || $[69] !== t12 || $[70] !== t13 || $[71] !== t14 || $[72] !== t24 ? (t25 = /* @__PURE__ */ jsxRuntime.jsx(T2, { height: t10, overflow: t11, padding: t12, sizing: t13, tone: t14, children: t24 }), $[66] = T2, $[67] = t10, $[68] = t11, $[69] = t12, $[70] = t13, $[71] = t14, $[72] = t24, $[73] = t25) : t25 = $[73], t25;
}
...
const DocumentTitle = (props) => {
  ...
  } = structure.useDocumentLastRev(documentId, documentType), documentTitle = lastRevisionDocument && !documentValue ? "" : isNewDocument ? t("browser-document-title.new-document", {
...
function _temp2$1(t0) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(React.Fragment, { children: pane === structure.LOADING_PANE ? /* @__PURE__ */ jsxRuntime.jsx(structure.LoadingPane, { paneKey, path, selected }) : /* @__PURE__ */ jsxRuntime.jsx(structure.StructureToolPane, { active, groupIndex, index: paneIndex, pane, childItemId, itemId, paneKey, params: paneParams, payload, path, selected, siblingIndex }) }, `${pane === structure.LOADING_PANE ? "loading" : pane.type}-${paneIndex}`);
}
