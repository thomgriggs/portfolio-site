...
function usePanelsStorage() {
  const $ = reactCompilerRuntime.c(1), get = _temp2$8, set = _temp3$4;
  let t0;
...
function DocumentListPane(props) {
  ...
  if ($[0] !== mainDocumentState?.document?._id || $[1] !== refs) {
    let t12;
    $[3] !== mainDocumentState?.document?._id ? (t12 = (r) => sanity.getPublishedId(r._id) !== mainDocumentState?.document?._id, $[3] = mainDocumentState?.document?._id, $[4] = t12) : t12 = $[4], t0 = refs.filter(t12).map(_temp$c), $[0] = mainDocumentState?.document?._id, $[1] = refs, $[2] = t0;
  } else
    t0 = $[2];
  const ids = t0;
  let t1;
  ...
  const handleRetry = t4, [structureParams] = React.useState(_temp2$6);
  let t5;
...
function OpenPreviewButton(props) {
  ...
  let t5;
  $[9] !== handleOpenPopup || $[10] !== openPreviewLink || $[11] !== t4 ? (t5 = /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.Button, { as: "a", "aria-label": t4, icon: icons.LaunchIcon, mode: "bleed", href: openPreviewLink, rel: "opener", target: "_blank", tooltipProps: null, onClick: handleOpenPopup }), $[9] = handleOpenPopup, $[10] = openPreviewLink, $[11] = t4, $[12] = t5) : t5 = $[12];
  let t6;
  return $[13] !== t2 || $[14] !== t5 ? (t6 = /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.Tooltip, { animate: !0, content: t2, fallbackPlacements: t3, placement: "bottom", portal: !0, children: t5 }), $[13] = t2, $[14] = t5, $[15] = t6) : t6 = $[15], t6;
}
...
const PreviewHeaderDefault = (props) => {
  ...
  const handleRefresh = t1, isLoading = react.useSelector(presentationRef, _temp$8), isLoaded = react.useSelector(presentationRef, _temp2$5), isRefreshing = react.useSelector(presentationRef, _temp3$2), isReloading = react.useSelector(presentationRef, _temp4$1), overlaysEnabled = react.useSelector(presentationRef, _temp5$1), previewURL = new URL(previewUrl || "/", targetOrigin), {
    pathname,
    search
  } = withoutSecretSearchParams.withoutSecretSearchParams(previewURL), previewLocationRoute = `${pathname}${search}`, perspectiveToggleTooltipId = useId(), previewUrlBusy = react.useSelector(previewUrlRef, _temp6);
  let t2;
  $[9] === Symbol.for("react.memo_cache_sentinel") ? (t2 = {
    width: "100%"
  }, $[9] = t2) : t2 = $[9];
  let t3;
  $[10] !== navigatorEnabled || $[11] !== t || $[12] !== toggleNavigator ? (t3 = toggleNavigator && /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.Button, { "aria-label": t("preview-frame.navigator.toggle-button.aria-label"), icon: icons.PanelLeftIcon, mode: "bleed", onClick: toggleNavigator, selected: navigatorEnabled, tooltipProps: {
  ...
  let t7;
  $[18] !== t6 ? (t7 = /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { padding: 1, children: /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: 1, children: t6 }) }), $[18] = t6, $[19] = t7) : t7 = $[19];
  let t8;
  $[20] === Symbol.for("react.memo_cache_sentinel") ? (t8 = /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { paddingY: 1, children: /* @__PURE__ */ jsxRuntime.jsx(ui.Hotkeys, { keys: ["Alt"], style: {
    marginTop: -4,
    marginBottom: -4
  } }) }), $[20] = t8) : t8 = $[20];
  let t9;
  $[21] !== t7 ? (t9 = /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { align: "center", style: t4, children: [
    t7,
    t8
  ] }), $[21] = t7, $[22] = t9) : t9 = $[22];
  let t10;
  ...
  let t16;
  $[26] !== overlaysEnabled || $[27] !== t14 || $[28] !== t15 || $[29] !== toggleOverlay ? (t16 = /* @__PURE__ */ jsxRuntime.jsx("div", { style: t13, children: /* @__PURE__ */ jsxRuntime.jsx(ui.Switch, { indeterminate: t14, checked: overlaysEnabled, onChange: toggleOverlay, disabled: t15 }) }), $[26] = overlaysEnabled, $[27] = t14, $[28] = t15, $[29] = toggleOverlay, $[30] = t16) : t16 = $[30];
  const t17 = !overlaysEnabled;
  let t18;
  $[31] !== t ? (t18 = t("preview-frame.overlay.toggle-button.text"), $[31] = t, $[32] = t18) : t18 = $[32];
  let t19;
  $[33] !== t17 || $[34] !== t18 ? (t19 = /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { children: /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { muted: t17, size: 1, weight: "medium", children: t18 }) }), $[33] = t17, $[34] = t18, $[35] = t19) : t19 = $[35];
  let t20;
  $[36] !== t16 || $[37] !== t19 ? (t20 = /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { align: "center", gap: 3, children: [
    t16,
    t19
  ] }), $[36] = t16, $[37] = t19, $[38] = t20) : t20 = $[38];
  let t21;
  $[39] !== t12 || $[40] !== t20 ? (t21 = /* @__PURE__ */ jsxRuntime.jsx(ui.Card, { as: "label", flex: "none", padding: 3, marginX: 1, style: t11, tone: t12, children: t20 }), $[39] = t12, $[40] = t20, $[41] = t21) : t21 = $[41];
  let t22;
  $[42] !== t21 || $[43] !== t9 ? (t22 = /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.Tooltip, { animate: !0, content: t9, fallbackPlacements: t10, placement: "bottom", portal: !0, children: t21 }), $[42] = t21, $[43] = t9, $[44] = t22) : t22 = $[44];
  let t23;
  ...
  let t24;
  $[51] !== t23 ? (t24 = /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: 1, children: t23 }), $[51] = t23, $[52] = t24) : t24 = $[52];
  let t25;
  ...
  let t28;
  $[56] !== handleRefresh || $[57] !== t26 || $[58] !== t27 ? (t28 = /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.Button, { "aria-label": t26, icon: icons.RefreshIcon, mode: "bleed", loading: t27, onClick: handleRefresh, tooltipProps: null }), $[56] = handleRefresh, $[57] = t26, $[58] = t27, $[59] = t28) : t28 = $[59];
  let t29;
  $[60] !== t24 || $[61] !== t28 ? (t29 = /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { padding: 1, children: /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.Tooltip, { animate: !0, content: t24, fallbackPlacements: t25, placement: "bottom", portal: !0, children: t28 }) }), $[60] = t24, $[61] = t28, $[62] = t29) : t29 = $[62];
  let t30;
  $[63] !== openPopup || $[64] !== perspective || $[65] !== previewLocationOrigin || $[66] !== previewLocationRoute || $[67] !== targetOrigin ? (t30 = /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { padding: 1, children: /* @__PURE__ */ jsxRuntime.jsx(OpenPreviewButton, { openPopup, previewLocationOrigin, previewLocationRoute, perspective, targetOrigin }) }), $[63] = openPopup, $[64] = perspective, $[65] = previewLocationOrigin, $[66] = previewLocationRoute, $[67] = targetOrigin, $[68] = t30) : t30 = $[68];
  let t31;
  $[69] !== onPathChange || $[70] !== previewLocationRoute || $[71] !== previewUrlRef || $[72] !== t29 || $[73] !== t30 ? (t31 = /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { flex: 1, children: /* @__PURE__ */ jsxRuntime.jsx(PreviewLocationInput, { previewUrlRef, prefix: t29, onChange: onPathChange, suffix: t30, value: previewLocationRoute }) }), $[69] = onPathChange, $[70] = previewLocationRoute, $[71] = previewUrlRef, $[72] = t29, $[73] = t30, $[74] = t31) : t31 = $[74];
  let t32;
  ...
  let t35;
  $[80] !== t34 ? (t35 = /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: 1, children: t34 }), $[80] = t34, $[81] = t35) : t35 = $[81];
  let t36;
  ...
  const t38 = viewport === "desktop" ? icons.MobileDeviceIcon : icons.DesktopIcon;
  let t39;
  $[85] !== t37 || $[86] !== t38 || $[87] !== toggleViewportSize || $[88] !== viewport ? (t39 = /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.Button, { "data-testid": "preview-viewport-toggle", "data-viewport": viewport, "aria-label": t37, icon: t38, mode: "bleed", onClick: toggleViewportSize, tooltipProps: null }), $[85] = t37, $[86] = t38, $[87] = toggleViewportSize, $[88] = viewport, $[89] = t39) : t39 = $[89];
  let t40;
  $[90] !== t32 || $[91] !== t35 || $[92] !== t39 ? (t40 = /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { align: "center", flex: "none", gap: 1, children: /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.Tooltip, { animate: !0, ref: t32, content: t35, fallbackPlacements: t36, placement: "bottom", portal: !0, children: t39 }) }), $[90] = t32, $[91] = t35, $[92] = t39, $[93] = t40) : t40 = $[93];
  let t41;
  $[94] !== canSharePreviewAccess || $[95] !== canToggleSharePreviewAccess || $[96] !== canUseSharedPreviewAccess || $[97] !== initialUrl || $[98] !== perspective || $[99] !== previewLocationRoute ? (t41 = canSharePreviewAccess && /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { align: "center", flex: "none", gap: 1, children: /* @__PURE__ */ jsxRuntime.jsx(SharePreviewMenu, { canToggleSharePreviewAccess, canUseSharedPreviewAccess, previewLocationRoute, initialUrl, perspective }) }), $[94] = canSharePreviewAccess, $[95] = canToggleSharePreviewAccess, $[96] = canUseSharedPreviewAccess, $[97] = initialUrl, $[98] = perspective, $[99] = previewLocationRoute, $[100] = t41) : t41 = $[100];
  let t42;
  return $[101] !== t22 || $[102] !== t3 || $[103] !== t31 || $[104] !== t40 || $[105] !== t41 ? (t42 = /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { align: "center", gap: 1, paddingX: 1, style: t2, children: [
    t3,
    t22,
    t31,
    t40,
...
function useParams({
  ...
  }), [params.changesInspectorTab, params.comment, params.inspect, params.instruction, params.path, params.pathKey, params.parentRefPath, params.rev, params.since, params.template, params.templateParams, params.view]), searchParams = React.useMemo(() => pruneObject({
  ...
  const [navigationHistory, setNavigationHistory] = React.useState([routerState]), isSameDocument = React.useCallback(({
    id: id_0,
    type: type_0
  }) => {
    const {
  ...
  }, []), navigate = React.useCallback((options) => {
    const {
      state,
      params: params_0,
      replace = !1
...
function PresentationTool(props) {
  const {
    ...
    routerSearchParams,
    frameStateRef
  }), presentationRef = react.useActorRef(presentationMachine), viewport = React.useMemo(() => params.viewport ? "mobile" : "desktop", [params.viewport]), [documentsOnPage, setDocumentsOnPage] = useDocumentsOnPage(perspective, frameStateRef), projectId = sanity.useProjectId(), dataset = sanity.useDataset(), mainDocumentState = useMainDocument({
    navigate,
    navigationHistory,
    path: params.preview,
    targetOrigin,
  ...
  const handleNavigate = useEffectEvent.useEffectEvent((options) => {
    navigate(options);
  });
  React.useEffect(() => {
  ...
  const handleFocusPath = React.useMemo(() => (
  ...
  ), [isSameDocument, navigate]), handlePreviewPath = React.useCallback((nextPath) => {
  ...
  }, [targetOrigin, params.preview, allowOrigins, navigate]), handleStructureParams = React.useCallback((params_0) => {
    navigate({
      params: params_0
    });
  }, [navigate]), handleEditReference = React.useCallback((options_0) => {
    navigate(options_0);
  }, [navigate]);
  React.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    /* @__PURE__ */ jsxRuntime.jsx(PresentationProvider, { devMode, name, navigate, params, searchParams, structureParams, children: /* @__PURE__ */ jsxRuntime.jsx(PresentationNavigateProvider, { navigate, children: /* @__PURE__ */ jsxRuntime.jsx(PresentationParamsProvider, { params, children: /* @__PURE__ */ jsxRuntime.jsx(SharedStateProvider, { comlink: visualEditingComlink, children: /* @__PURE__ */ jsxRuntime.jsx(Container, { "data-testid": "presentation-root", height: "fill", children: /* @__PURE__ */ jsxRuntime.jsxs(Panels, { children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(PresentationContent, { documentId: params.id, documentsOnPage, documentType: params.type, getCommentIntent, mainDocumentState, onEditReference: handleEditReference, onFocusPath: handleFocusPath, onStructureParams: handleStructureParams, searchParams, setDisplayedDocument, structureParams })
    ] }) }) }) }) }) }),
