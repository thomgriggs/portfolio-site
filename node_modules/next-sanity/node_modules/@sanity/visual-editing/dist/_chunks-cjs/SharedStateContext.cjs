"use strict";
var reactCompilerRuntime = require("react-compiler-runtime"), csm = require("@sanity/client/csm"), react = require("react"), context = require("./context.cjs"), mutations = require("./mutations.cjs"), visualEditingCsm = require("@sanity/visual-editing-csm"), stega = require("@vercel/stega");
function useOptimistic(passthrough, reducer) {
  const $ = reactCompilerRuntime.c(17), [pristine, setPristine] = react.useState(!0), [optimistic, setOptimistic] = react.useState(passthrough), [lastEvent, setLastEvent] = react.useState(null), [lastPassthrough, setLastPassthrough] = react.useState(passthrough), actor = mutations.useOptimisticActor(), reduceStateFromActionRef = react.useRef(null);
  let t0, t1;
  $[0] !== reducer ? (t0 = () => {
  ...
  }, t1 = [reducer], $[0] = reducer, $[1] = t0, $[2] = t1) : (t0 = $[1], t1 = $[2]), react.useInsertionEffect(t0, t1);
  let t2;
  $[3] !== passthrough ? (t2 = () => setLastPassthrough(passthrough), $[3] = passthrough, $[4] = t2) : t2 = $[4];
  const updateLastPassthroughRef = react.useRef(t2);
  let t3, t4;
  $[5] !== passthrough ? (t3 = () => {
    updateLastPassthroughRef.current = () => setLastPassthrough(passthrough);
  }, t4 = [passthrough], $[5] = passthrough, $[6] = t3, $[7] = t4) : (t3 = $[6], t4 = $[7]), react.useInsertionEffect(t3, t4);
  let t5, t6;
  $[8] !== actor ? (t5 = () => {
  ...
  }, t6 = [actor], $[8] = actor, $[9] = t5, $[10] = t6) : (t5 = $[9], t6 = $[10]), react.useEffect(t5, t6);
  let t7, t8;
  ...
  }, t8 = [lastEvent, lastPassthrough, passthrough, pristine], $[11] = lastEvent, $[12] = lastPassthrough, $[13] = passthrough, $[14] = pristine, $[15] = t7, $[16] = t8) : (t7 = $[15], t8 = $[16]), react.useEffect(t7, t8), pristine ? passthrough : optimistic;
}
const byteToHex = [];
for (let i = 0; i < 256; ++i)
