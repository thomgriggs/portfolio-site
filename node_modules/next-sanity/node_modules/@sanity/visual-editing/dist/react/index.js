...
import { useEffect, createContext, useContext, useState, memo, useRef, useId, Fragment as Fragment$1, isValidElement, useSyncExternalStore, useDeferredValue, useReducer, useCallback } from "react";
...
const DocumentReporter = (props) => {
  ...
  const {
    ...
    dispatchDragEndEvent
  } = useDragEndEvents(), sendTelemetry = useTelemetry(), overlayEventHandler = useCallback((message) => {
  ...
  const closeContextMenu = t10, optimisticActorReady = useOptimisticActorReady(), componentResolver = optimisticActorReady ? _componentResolver : void 0;
  let t11;
  bb0: {
