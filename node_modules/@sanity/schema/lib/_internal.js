...
function convertCommonTypeDef(schemaType, opts) {
  const ownProps = Schema.OWN_PROPS_NAME in schemaType ? schemaType[Schema.OWN_PROPS_NAME] : schemaType;
  let fields;
...
const builtinTypes = [
  ...
  imagePalette,
  imagePaletteSwatch
], builtinSchema = Schema.Schema.compile({
  name: "studio",
  types: builtinTypes
});
...
exports.ALL_FIELDS_GROUP_NAME = Schema.ALL_FIELDS_GROUP_NAME;
exports.DEFAULT_MAX_FIELD_DEPTH = Schema.DEFAULT_MAX_FIELD_DEPTH;
exports.resolveSearchConfig = Schema.resolveSearchConfig;
exports.resolveSearchConfigForBaseFieldPaths = Schema.resolveSearchConfigForBaseFieldPaths;
