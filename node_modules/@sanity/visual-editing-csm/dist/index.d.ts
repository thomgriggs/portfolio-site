 ...
 * @public
 */
export declare function encodeSanityNodeData(node: SanityNode): string | undefined

/** @internal */
export declare function pathToUrlString(path: Path): string
...
/** @internal */
export declare function urlStringToPath(str: string): Path
