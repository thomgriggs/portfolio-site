...
async function prepareBatch4() {
  console.log('📋 Preparing Batch 4 - Next 10 mismatches...');
  ...
  try {
    ...
    console.log(`\n🎯 BATCH 4 - Next 10 mismatches in CORRECT archive order:`);
    console.log(`Total mismatches found: ${mismatches.length}`);
    console.log(`\n📋 Projects to fix in this batch (31-40):`);
    
    const batch4 = mismatches.slice(30, 40);
    batch4.forEach((item, i) => {
