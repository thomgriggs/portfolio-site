...
// Projects to capture multiple pages for
const projects = [
  {
    name: 'Hotel Palombaggia',
    baseUrl: 'https://hotelpalombaggia.com',
    pages: [
      { path: '', name: 'homepage' },
...
async function captureMultiplePages() {
  console.log('🚀 Starting MULTIPLE PAGES screenshot capture...');
  console.log(`📦 Processing ${projects.length} projects with multiple pages`);
  console.log('');
  ...
  // Summary
  console.log('\n' + '='.repeat(60));
  console.log('📊 MULTIPLE PAGES SUMMARY');
  ...
  console.log(`\n🎉 Multiple pages capture complete!`);
}

// Run the multiple pages capture
