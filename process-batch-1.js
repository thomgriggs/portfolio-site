...
async function processBatch1() {
  console.log('🔧 Processing Batch 1 - First 10 mismatches...');

  const batch1 = [
    { title: "Hotel Parc Montsouris", correct: "hotel-parc-montsouris.webp", archiveIndex: 12 },
    { title: "Hotel Paris Petitlouvre", correct: "hotel-paris-petitlouvre.webp", archiveIndex: 13 },
    { title: "Hotel Paris Printemps", correct: "hotel-paris-printemps.webp", archiveIndex: 14 },
    { title: "Hotel WYLD Saint Germain", correct: "hotel-paris-stgermain.webp", archiveIndex: 15 },
    { title: "Hotel Royal St Honore", correct: "hotel-royal-st-honore.webp", archiveIndex: 16 },
    { title: "Hotel de la Boetie", correct: "hoteldelaboetie.webp", archiveIndex: 19 },
    { title: "Hotel Sparis Versailles", correct: "hotelsparisversailles.webp", archiveIndex: 21 },
    { title: "Hotel Waldorf", correct: "hotelwaldorf.webp", archiveIndex: 22 },
    { title: "Ivi Mare Paphos", correct: "ivimarepaphos.webp", archiveIndex: 23 },
    { title: "The Augustin", correct: "theaugustin.webp", archiveIndex: 25 }
  ];
