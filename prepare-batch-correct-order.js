...
async function prepareFirstBatchCorrectOrder() {
  console.log('📋 Preparing first batch using CORRECT archive order...');
  ...
  try {
    ...
    console.log(`\n🎯 BATCH 1 - First 10 mismatches in CORRECT archive order:`);
