...
(async () => {
  ...
  await page.waitForTimeout(10000); // Extra time for background images
  ...
  await page.screenshot({
    path: 'captured-screenshots/bernard-loiseau-timing2.png', 
    fullPage: false
  });
  
  await browser.close();
  console.log('✅ Done - with image loading');
})();
